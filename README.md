...
> [Open English HTML](https://lumina-30.github.io/institutional-friction-toolkit/index.html)  
>
> 日本語で読む場合も、このREADME.mdに留まらず、日本語HTML入口を使用してください：  
> [日本語HTMLを開く](https://lumina-30.github.io/institutional-friction-toolkit/index-ja.html)  
>
