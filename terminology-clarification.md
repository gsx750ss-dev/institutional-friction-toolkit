...
It exists solely to reduce semantic confusion.
It does not introduce new concepts, requirements, or evaluations.
...
It does not redefine legal, technical, ethical,
or policy terminology outside this context.
...
When used, "control" refers only to
institutional or procedural constraints
on authorization, deployment, or repetition.
...
When referenced, "safety" refers only to
post-hoc institutional handling
and stabilization after events.
...
The term is not used to describe
internal system properties,
but may appear only in descriptions of
external institutional consistency.
...
to indicate operational independence
from immediate human intervention.
...
drives unnecessary conflict or acceleration.
