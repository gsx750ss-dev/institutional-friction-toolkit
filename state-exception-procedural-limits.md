...
It does not prohibit state action.
It defines procedural constraints to prevent normalization.
...
Renewal requires independent review.
...
Institutional or collective signatures are insufficient.
...
Each case requires independent justification.
